...
class SEODataProvider(Protocol):
    ...
    async def serp(self, keyword: str, language_code: str = "en", location_code: int = 2840, depth: int = 100) -> list[dict]: ...
    async def serp_batch(self, keywords: list[str], language_code: str = "en", location_code: int = 2840, depth: int = 100) -> dict[str, list[dict]]: ...
