...
api_router.include_router(product3d.router, prefix="/images", tags=["product-3d"])
...
api_router.include_router(model_catalog.router, prefix="/model-catalog", tags=["model-catalog"])
